package com.altun.courseerp.configs;


import com.altun.courseerp.exception.BaseException;
import com.altun.courseerp.filters.AuthorationFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,
                                                   AuthorationFilter authorizationFilter, AuthEntryPoint authEntryPoint) throws Exception {
        return http
